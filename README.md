...
stops — тип array(string), список названий остановок, входящих в маршрут.
...
routes — тип array(string), список названий маршрутов, обслуживающихся этой транспортной компанией.

terminals — тип array(int), список id терминалов, принадлежащих транспортной компании.
